 ...
 * ones. </p>
 * 
 * By default, a current {@link app.poly.myapp.doggy.libs.views.dialogs.Boast} notification will be cancelled by a
...
public class Boast {
	/**
	 * Keeps track of certain {@link app.poly.myapp.doggy.libs.views.dialogs.Boast} notifications that may need to be
	...
	/**
	 * Private constructor creates a new {@link app.poly.myapp.doggy.libs.views.dialogs.Boast} from a given
