...
public class KeyGlobal {
    public final static String FROM_ACTIVITY = "FROM_ACTIVITY";
    ...
    public final static String HOME_HISTORY_ACTIVITY = "HOME_HISTORY_ACTIVITY";
    public final static String SMS_RECEIVER = "SMS_RECEIVER";

    public final static String KEY_APP = "nearly_2015";
    public final static String SMS_ID = "smsid";
